...
/*   Updated: 2023/05/24 22:43:03 by hchakoub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char *request_methods[] = {"GET", "POST", "DELETE", NULL};
...
void Settings::setRequestMethods_() {
  ...
  while (request_methods[i]) {
    this->request_methods_.insert(
        std::make_pair(request_methods[i], static_cast<Request_Method_e>(i)));
    i++;
  }
}
